...
execute as @e[type=area_effect_cloud,tag=Spawner] at @s run function more_monsters:spawn
kill @e[type=item,nbt={Item:{id:"minecraft:barrier",tag:{ItemId:More_Monsters}}}]

#アイテムを持つMobが現れる用に、定期的にPersistenceRequiredを0bにする
execute unless entity 00000000-0000-0006-0000-000000000006 as @e[type=#more_monsters:naturally_spawn_hostile,tag=More_Monsters,predicate=!more_monsters:donot_despawn_item] unless data entity @s CustomName run data merge entity @s {PersistenceRequired:0b}
execute unless entity 00000000-0000-0006-0000-000000000006 run summon minecraft:area_effect_cloud 0 0 0 {Duration:1200,Particle:"minecraft:note",Tags:["More_Monsters_CoolTime"],UUIDMost:6l,UUIDLeast:6l}
