execute as @s at @s if entity @e[tag=SpawnMonsters,type=#more_monsters:nether_hostile,limit=1,dx=0,dy=0,dz=0] run loot spawn ~ ~ ~ loot more_monsters:random/nether_hostile
