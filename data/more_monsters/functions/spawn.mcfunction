...
execute as @s unless entity @s[tag=!Overworld,tag=!Nether,tag=!End,tag=!Drowned,tag=!Ghast,tag=!Guardian,tag=!Phantom] run tag @s add HasTag
...
execute as @s at @s unless entity @s[tag=!Drowned,tag=!Ghast,tag=!Guardian,tag=!Phantom] run loot spawn ~ ~ ~ loot more_monsters:random/other_hostile
